...
var clue_description = "A bloody painting found in the kitchen."
var clue_icon = preload("res://art/Clues/testclue.png") # Replace with the actual path to your clue's icon
